              ...
              <div className="space-y-3">
                ...
                {/* Lösungsvorschlag */}
                 {item.improvementProposal && (
                  <div className="bg-neutral-950/50 p-3 rounded text-xs text-neutral-300 border-l-2 border-yellow-500/50 flex gap-3 items-start">
 <svg 
                      viewBox="0 -8 72 72" 
                      className="text-yellow-500 flex-shrink-0 mt-0.5 h-full fill-current" 
                      style={{ width: '3em' }}
                    ...
                    <span className="leading-relaxed">{item.improvementProposal}</span>
                  </div>
                )}
              </div>
